...
//高级锁，预计线程等待锁的时间比较短时、CPU资源不紧张、多核、加锁代码经常被调用，但竞争情况很少发生时用自旋锁比较划算
//自旋锁是等待锁的线程会一直处于忙等状态，一直占用CPU资源，不再安全，可能会出现优先级反转问题，如果线程是使用休眠的方式就可以解决这个问题，性能较高，因为不会让线程休眠，线程休眠再唤醒也是需要消耗资源的
